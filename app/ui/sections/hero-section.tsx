...
export default function Hero() {
  return (
    <div className="w-11/12 mx-auto mt-4 rounded-lg px-4 py-2 bg-secondary-background-light dark:bg-secondary-background-dark transition-colors duration-300">
      <Header />
