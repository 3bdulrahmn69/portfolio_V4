...
const Button = ({
  ...
  const variantStyles = {
    primary:
      'bg-primary-light dark:bg-primary-dark text-text-dark dark:text-text-light rounded-lg relative z-[1] px-3 py-2 overflow-hidden after:absolute after:-top-1/2 after:-bottom-1/2 after:left-0 after:w-5 after:content-[""] after:z-[-1] after:bg-[#ffffff33] shine',
    secondary: '',
    tertiary:
